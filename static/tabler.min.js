	...
	*/
	...
	var Dropdown = function (_BaseComponent) {
	  ...
	  _proto.toggle = function toggle() {
	    ...
	    // Dropdown.clearMenus(); function commented and move to below isActive condition due to menu not working
      if (isActive) {
        Dropdown.clearMenus(); // FUnction Changed due to parent hide when child is visible
        return;
      }
	    this.show();
	  };
